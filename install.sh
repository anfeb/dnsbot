...
echo -e "\033[1;33mJAWAB PERTANYAAN BERIKUT SEBELUM MENGGUNAKAN DNS BOT\033[0m\n"
...
echo -e "\033[1;32mAnda Mencukupi Umur Untuk Menggunakan Dns Bot\nWelcome Gunakan Dns Bot Dengan Bijak Dan Tidak Menjual Belikan Script Dns Bot\033[0m"
...
echo -e "\033[1;33mDNS BOT BERHASIL DI INSTALL KETIK NPM START UNTUK MENJALANKAN DNS BOT\033[0m"
